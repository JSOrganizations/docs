...
| `prices` | Array of Object | Yes | Price breakdown, a JSON-serialized list of components. |
...
| `payload` | String | Yes | Bot-defined invoice payload. |
| `currency` | String | Yes | Three-letter ISO 4217 currency code. |
| `prices` | Array of Object | Yes | Price breakdown. |
...
Bot.sendMessage(chat_id=u, text=f"Pay here: {link.result}")
```
...
| `errors` | Array of Object | Yes | A JSON-serialized array describing the errors. |
