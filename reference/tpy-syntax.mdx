---
title: 'TPY Syntax & Variables'
description: 'Understanding the Restricted Python environment and built-in variables'
---

Bots Limited uses a custom execution environment called **TPY**. TPY is built on top of standard Python 3, but with specific security restrictions to ensure safe execution on our cloud platform.
