...
description: 'Build powerful Telegram Bots with BLP Language in minutes'
---
...
- **BLP Architecture:** Write in BLP Language designed exclusively for Telegram automation.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Understand BLP"
    icon="code"
    href="/reference/blp-syntax"
  >
